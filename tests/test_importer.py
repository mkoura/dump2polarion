...
from dump2polarion.importer import get_importer
...
class TestImporterFormats(object):
    def test_ostriz_local(self):
        importer = get_importer('test_ostriz_file.json')
