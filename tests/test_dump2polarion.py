...
def test_top_element(config_prop, records_ids):
    exporter = d2p.XunitExport('5_8_0_17', records_ids, config_prop, transform_func=lambda: None)
...
class TestE2E(object):
    ...
    def test_e2e_ids_transform(self, config_prop, records_ids):
        exporter = d2p.XunitExport('5_8_0_17', records_ids, config_prop)
        complete = exporter.export()
    ...
    def test_e2e_names_transform(self, config_prop, records_names):
        exporter = d2p.XunitExport('5_8_0_17', records_names, config_prop)
        complete = exporter.export()
